fn main() {
    ...
    println!("\nThe {} is formed by the aspiration to train electrical/electronice engineering professionals
        in the areas of design, building and maintenance of electrical controlled systemms,", n4);
